...
Los cuatro tipos principales usados para la TRH son \textit{Valerato de Estradiol} (EV, del inglés Estradiol Valerate), \textit{Cipionato de Estradiol} (EC, del inglés Estradiol Cypionate), \textit{Enantato de Estradiol} (EEn, del inglés Estradiol Enanthate) y \textit{Undecanoato de Estradiol} (EUn, del inglés Estradiol Undecylate). Cada uno de estos es un “éster” de \textit{estradiol} (E2) y será convertido a \textit{estradiol} en tu cuerpo.
